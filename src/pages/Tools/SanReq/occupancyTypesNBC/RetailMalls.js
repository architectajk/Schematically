...
import image from '../../../../assets/SanReq/15.png'
...
const RetailMalls = () => {
  ...
  const PublicUrinalCount=()=>{
    ...
    if (m<25 & m>0){PublicUrinalCount=1}
  ...
  const StaffMaleBathCount=()=> calculateFacilityCount(staffMale,100)
  const StaffFemaleBathCount=()=> calculateFacilityCount(staffFemale,100)
        ...
        <table className={`table table-${mode} table-hover table-bordered w-75 align-middle`}>
          <thead className='align-middle'>
            <tr>
              ...
              <th scope="col" colSpan="2">Staff Toilets in Shopping Building</th>
