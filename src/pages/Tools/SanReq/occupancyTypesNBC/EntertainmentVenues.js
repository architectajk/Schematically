...
import image from '../../../../assets/SanReq/3.png'
...
const EntertainmentVenues=()=> {
  ...
  const PublicFemaleWcCount=()=>{
    ...
    if(f>200){publicFemaleWcCount=((f-200)*0.02)+6}
    else if (f<33 & f>0){publicFemaleWcCount=1}
    else {publicFemaleWcCount=f*0.03}
