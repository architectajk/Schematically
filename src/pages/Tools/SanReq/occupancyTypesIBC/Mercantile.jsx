...
const Mercantile = () => {
  ...
  const MaleWcCount = calculateCount(male,0,0.002,1,0)
  const FemaleWcCount = calculateCount(female,0,0.002,1,0)
  const UrinalCount = Math.floor(MaleWcCount*0.67);
  const MaleWbCount = calculateCount(male,0,0.0013,1,0)
  const FemaleWbCount = calculateCount(female,0,0.0013,1,0)
