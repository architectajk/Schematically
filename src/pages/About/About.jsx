...
machine into one, making the design process fun.</p>
    ...
    <div className={`col-sm-6 d-flex flex-column text-${mode==='light'?'dark':'light'}`}>
      ...
      <p className='fs-5'>As I understand the challenges of balancing creativity and productivity,I am working on <p className='d-inline fw-bolder'>Bridging the Gap</p> and Empower individuals and teams to bring their ideas to life with ease.Whether you're an architect visualizing a new structure, a designer crafting digital masterpieces, or a professional looking to streamline your workflow, Schematically is your go-to platform.</p>
    </div>
    <div className={`text-${mode==='light'?'dark':'light'}`}>
      ...
      <p><span className="badge align-items-center p-1 pe-2 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-pill me-2">LinkedIn</span>- 
      <Link to="https://www.linkedin.com/in/akshay-j-kamath" target="_blank" rel="noopener noreferrer">https://www.linkedin.com/in/akshay-j-kamath</Link></p>
      <p><span className="badge align-items-center p-1 pe-2 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-pill me-2">Github</span>- 
      <Link to="https://github.com/architectajk" target="_blank" rel="noopener noreferrer">https://github.com/architectajk</Link></p>
      <p><span className="badge align-items-center p-1 pe-2 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-pill me-2">E-Mail</span>
